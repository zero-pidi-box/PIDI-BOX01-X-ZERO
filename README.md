...
should be available  in the directory DOCUMENTS in near future 
...
NO  VDE, CE or other certificates are available. Do not use relay outputs with high voltage.

**All printed boards are designed with KICAD 9** including labels, front panels and some drawings for plug breakthroughs .

Not included are the BOM’s of circuit boards. They should be generated by the user itself in KICAD.

Module BOM’s are available soon  in the documents area step by step.
